exports.StaticContext = function (parent, pos, processor) {
    ...
    if(!parent) {
      var arrNamespaces = require('./lib/compiler/namespaces')
      arrNamespaces.map(arrNamespaces => namespaces[arrNamespaces.namespace] = arrNamespaces.options );
     /*
    ...
    var s = {
        ...
        defaultFunctionNamespaces: require('./lib/compiler/default_function_namespaces'),
    ...
    if(processor === '28msec')
      var myNamespaces = require('./lib/compiler/28msec')
      myNamespaces.map(myNamespaces => namespaces[myNamespaces.namespace] = myNamespaces.options );
}
