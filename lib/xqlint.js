...
/**
 * look for processor option 'eXist'  ( or 28msec or baseX or ext )
 * so we can deal with namespaces specfic to 'eXist'
 *  @see compiler/static_context.js
 *
 */
...
exports.XQLint = function (source, opts) {
    ...
    var ast, xqdoc;
    // if not set, set static context using opts.processor
